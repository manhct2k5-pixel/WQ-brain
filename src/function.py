...
PRICE_INV = Terminal('inverse(close)', Int(1), 0.4)
PRICE_DELAY3 = Terminal('(close/ts_delay(close, 3)-1)', Int(1), 0.8)
PRICE_DELAY_CORR = Terminal('ts_corr(close,ts_delay(close, 1),10)', Int(1), 0.7)
TREND_VOLUME_3 = Terminal('multiply((close/ts_delay(close, 3)-1),rank(volume))', Int(1), 0.7)
...
TERMINALS = [OPEN, CLOSE, HIGH, LOW, VWAP, VOLUME, ADV, RET, MOMENTUM, REVERSAL,
             PRICE_INV, PRICE_DELAY3, PRICE_DELAY_CORR, TREND_VOLUME_3,
